...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/iILrxs
...
ALTER TABLE "employee_titles" ADD CONSTRAINT "fk_employee_titles_title_no" FOREIGN KEY("title_no")
